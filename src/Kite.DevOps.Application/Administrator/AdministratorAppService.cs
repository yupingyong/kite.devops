using Kite.DevOps.Application.Contracts.Administrator;
using Kite.DevOps.Application.Contracts.Administrator.Dtos;
using Kite.DevOps.Domain.Administrator;
...
using Mapster;
using Kite.DevOps.Domain.Shared;

namespace Kite.DevOps.Application.Administrator
{
    public class AdministratorAppService : BaseApplicationService, IAdministratorAppService
    {
        private readonly IRepository<Domain.Entities.Administrator> _repository;
        private readonly IAdministratorManager _administratorManager;

        public AdministratorAppService(IAdministratorManager administratorManager, IRepository<Domain.Entities.Administrator> repository)
        {
